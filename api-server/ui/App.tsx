...
import { fromLocalStorage } from './timeselection-state'
...
const timeSelectionState = fromLocalStorage()
      ...
      <Switch>
        <Route path="/map">
          <ErrorBoundary>
            ...
            <MapPanel vesselSelection={vesselSelectionState} timeSelection={timeSelectionState}/>
          </ErrorBoundary>
        </Route>
        <Route path="/tracklengths">
          <TrackLengthsPanel vesselSelection={vesselSelectionState} timeSelection={timeSelectionState}/>
        </Route>
