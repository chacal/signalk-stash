...
export type TrackLengthsFetcher = (vesselId: VesselId, year: Year) => Promise<TrackLength[]>

export function fetchTrackLengths(vesselId: VesselId, year: Year): Promise<TrackLength[]> {
